...
import { 
  ...
  Eye, Save, Wand2, User, Building2, Calendar, Loader2, Mail,
  Layers, LayoutGrid, Zap
} from 'lucide-react';
...
import { SequenceBuilder } from '@/components/emails/SequenceBuilder';
import { motion } from 'framer-motion';
import type { EmailTemplate as PredefinedTemplate } from '@/lib/email-templates';
...
export default function EmailsIA() {
  ...
  const [activeTab, setActiveTab] = useState<'templates' | 'library' | 'sequences'>('templates');
  ...
  const handleUseLibraryTemplate = (template: PredefinedTemplate) => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-semibold tracking-tight">Emails IA</h1>
        <p className="text-muted-foreground">Templates et séquences automatisées</p>
      </div>
      {/* Main Tabs */}
        <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as typeof activeTab)}>
            ...
            {isLoading ? (
              ...
              <Card className="p-12 bg-card/50 border-border/50 text-center">
                ...
                <p className="text-sm text-muted-foreground mb-6">
                  Créez votre premier template ou explorez la bibliothèque
                </p>
          ...
          <TabsContent value="library" className="mt-6">
            <TemplateLibrary onSelectTemplate={handleUseLibraryTemplate} />
          </TabsContent>
