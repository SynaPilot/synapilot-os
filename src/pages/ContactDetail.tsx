...
import { ContactAIConversation } from '@/components/contacts/ContactAIConversation';
...
export default function ContactDetail() {
  ...
  const getScoreColor = (score: number | null) => {
    ...
    if (score >= 80) return 'bg-error/20 text-error border-error/30';
  ...
  return (
    ...
    >
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap items-center gap-2 pt-1">
                  ...
                  <Badge className={cn('text-xs', getScoreColor(contact.urgency_score))}>
                    Score: {contact.urgency_score || 0}/100
                  </Badge>
      ...
      {/* Main content grid */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Left column - Score + Informations */}
        <div className="space-y-6">
          {/* Lead Score Card */}
          <LeadScoreCard
            contact={contact}
            activities={activities || []}
            onCallNow={contact.phone ? () => window.open(`tel:${contact.phone}`, '_self') : undefined}
          />
      ...
      {/* Section 3: Qualification IA */}
      <ContactAIConversation contact={contact} />

      {/* Section 4: Deals & Properties */}
